...
/*!******************************************!*\
  ...
  \******************************************/
/*! namespace exports */
/*! export RuleList [provided] [no usage info] [missing usage info prevents renaming] */
/*! export SheetsManager [provided] [no usage info] [missing usage info prevents renaming] */
/*! export SheetsRegistry [provided] [no usage info] [missing usage info prevents renaming] */
/*! export create [provided] [no usage info] [missing usage info prevents renaming] */
/*! export createGenerateId [provided] [no usage info] [missing usage info prevents renaming] */
/*! export createRule [provided] [no usage info] [missing usage info prevents renaming] */
/*! export default [provided] [no usage info] [missing usage info prevents renaming] */
/*! export getDynamicStyles [provided] [no usage info] [missing usage info prevents renaming] */
/*! export hasCSSTOMSupport [provided] [no usage info] [missing usage info prevents renaming] */
/*! export sheets [provided] [no usage info] [missing usage info prevents renaming] */
/*! export toCssValue [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
/*! runtime requirements: __webpack_require__, __webpack_exports__, __webpack_require__.r, __webpack_require__.d, __webpack_require__.* */
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/dataAccess/server-api.js":
/*!**************************************!*\
  !*** ./src/dataAccess/server-api.js ***!
  \**************************************/
/*! namespace exports */
/*! export deleteTaskFromServer [provided] [no usage info] [missing usage info prevents renaming] */
/*! export getAllTasksFromServer [provided] [no usage info] [missing usage info prevents renaming] */
/*! export saveTaskToServer [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "saveTaskToServer": () => /* binding */ saveTaskToServer,
/* harmony export */   "getAllTasksFromServer": () => /* binding */ getAllTasksFromServer,
...
const saveTaskToServer = async (task) => {
    const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().post('/api/v1/tasks', task);
...
const deleteTaskFromServer = async (taskId) => {
    return await axios__WEBPACK_IMPORTED_MODULE_0___default().delete('/api/v1/tasks/' + taskId);
}
...
/* harmony import */ var _dataAccess_server_api_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./dataAccess/server-api.js */ "./src/dataAccess/server-api.js");
;
...
const numOfTasksHeaderArea = new _views_NumOfTasksHeader_js__WEBPACK_IMPORTED_MODULE_2__.NumOfTasksHeader();
...
(async function() {
    try {
        const tasks = await (0,_dataAccess_server_api_js__WEBPACK_IMPORTED_MODULE_7__.getAllTasksFromServer)();
...
addTaskArea.addAreaDiv.addEventListener("enterPressedOrButtonClicked", async () => {
    if (addTaskArea.getInputValue() !== "") {
        ...
        try {
            const task = await (0,_dataAccess_server_api_js__WEBPACK_IMPORTED_MODULE_7__.saveTaskToServer)(taskToAdd);
            addTaskToDom(task);
...
const checkboxClicked = (taskAdded) => {
    ...
    (0,_dataAccess_server_api_js__WEBPACK_IMPORTED_MODULE_7__.saveTaskToServer)(taskAdded)
...
const deleteButtonClicked = async (taskDiv) => {
    try {
       await (0,_dataAccess_server_api_js__WEBPACK_IMPORTED_MODULE_7__.deleteTaskFromServer)(taskDiv.id); 
...
/***/ "./src/views/AddTaskArea.js":
/*!**********************************!*\
  !*** ./src/views/AddTaskArea.js ***!
  \**********************************/
/*! namespace exports */
/*! export AddTaskArea [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
...
/***/ "./src/views/NumOfTasksHeader.js":
/*!***************************************!*\
  !*** ./src/views/NumOfTasksHeader.js ***!
  \***************************************/
/*! namespace exports */
/*! export NumOfTasksHeader [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
/*! runtime requirements: __webpack_require__, __webpack_require__.r, __webpack_exports__, __webpack_require__.d, __webpack_require__.* */
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "NumOfTasksHeader": () => /* binding */ NumOfTasksHeader
/* harmony export */ });
/* harmony import */ var jss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jss */ "./node_modules/jss/dist/jss.esm.js");
...
/***/ "./src/views/TasksArea.js":
/*!********************************!*\
  !*** ./src/views/TasksArea.js ***!
  \********************************/
/*! namespace exports */
/*! export TasksArea [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
/*! runtime requirements: __webpack_require__, __webpack_require__.r, __webpack_exports__, __webpack_require__.d, __webpack_require__.* */
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
