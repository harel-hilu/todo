...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _localstorage_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./localstorage.js */ \"./src/localstorage.js\");\n/* harmony import */ var _task_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./task.js */ \"./src/task.js\");\n/* harmony import */ var _taskToAddInput_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./taskToAddInput.js */ \"./src/taskToAddInput.js\");\n\n\n\n\nwindow.addEventListener(\"load\", () => {\n    \n    Object(_localstorage_js__WEBPACK_IMPORTED_MODULE_0__[\"getTasksFromStorage\"])().forEach(task => addTask(task));\n    \n    document.getElementById(\"addTaskButton\").addEventListener(\"click\", addTaskHandler);\n    Object(_taskToAddInput_js__WEBPACK_IMPORTED_MODULE_2__[\"getTaskToAddInputElem\"])().addEventListener(\"keydown\", (e) => { \n        if (e.code === \"Enter\"){\n            addTaskHandler();\n        }\n    })\n\n    Object(_taskToAddInput_js__WEBPACK_IMPORTED_MODULE_2__[\"focusTaskToAddInput\"])();\n});\n\nlet addTaskHandler = () => {\n    if (!Object(_taskToAddInput_js__WEBPACK_IMPORTED_MODULE_2__[\"isEmptyTaskToAddInput\"])()){\n        let taskToAdd = new _task_js__WEBPACK_IMPORTED_MODULE_1__[\"Task\"]({taskText: Object(_taskToAddInput_js__WEBPACK_IMPORTED_MODULE_2__[\"getTaskToAddInputText\"])()});\n        addTask(taskToAdd);\n        Object(_localstorage_js__WEBPACK_IMPORTED_MODULE_0__[\"saveTaskToStorage\"])(taskToAdd);\n        Object(_taskToAddInput_js__WEBPACK_IMPORTED_MODULE_2__[\"clearTaskToAddInput\"])();\n    }    \n    \n    Object(_taskToAddInput_js__WEBPACK_IMPORTED_MODULE_2__[\"focusTaskToAddInput\"])();    \n};\n\nlet addTask = (task) => {\n    const newTaskDiv = document.createElement(\"div\");\n    newTaskDiv.setAttribute(\"id\", task.id);\n\n    newTaskDiv.append(createCheckbox(task.isComplete));\n    newTaskDiv.append(createLabel(task.text));\n    newTaskDiv.append(createDeleteButton(newTaskDiv));\n    newTaskDiv.append(createEditButton(newTaskDiv));\n    document.getElementById(\"tasksList\").append(newTaskDiv);\n};\n\nlet createLabel = (taskText) => {\n    const label = document.createElement(\"label\");\n    label.setAttribute(\"contenteditable\", \"true\");\n    label.append(document.createTextNode(taskText));\n\n    return label;\n}\n\nlet createCheckbox = (isComplete) => {\n    const checkbox = document.createElement(\"input\");\n    checkbox.setAttribute(\"type\", \"checkbox\");\n\n    if(isComplete) {\n        checkbox.setAttribute(\"checked\");\n    }\n\n    return checkbox;\n}\n\nlet createEditButton = (newTaskDiv) => {\n    const editButton = document.createElement(\"button\");\n    editButton.appendChild(document.createTextNode(\"Edit\"));\n    editButton.addEventListener(\"click\", () => {\n        Object(_localstorage_js__WEBPACK_IMPORTED_MODULE_0__[\"removeTaskFromStorage\"])(newTaskDiv);\n        newTaskDiv.querySelector(\"label\").focus();\n    });\n\n    newTaskDiv.querySelector(\"label\").addEventListener(\"focusout\", () => {\n        \n        Object(_localstorage_js__WEBPACK_IMPORTED_MODULE_0__[\"saveTaskToStorage\"])(new _task_js__WEBPACK_IMPORTED_MODULE_1__[\"Task\"]({ \"taskId\": newTaskDiv.id, \n                                    \"taskText\": newTaskDiv.querySelector(\"label\").innerHTML, \n                                   \"isTaskComplete\": newTaskDiv.querySelector(\"input\").checked }));\n    });\n\n    return editButton;\n}\n\nlet createDeleteButton = (newTaskDiv) => {\n    \n    const deleteButton = document.createElement(\"button\");\n    deleteButton.appendChild(document.createTextNode(\"Delete\"));\n    deleteButton.addEventListener(\"click\", () => {\n        Object(_localstorage_js__WEBPACK_IMPORTED_MODULE_0__[\"removeTaskFromStorage\"])(newTaskDiv)\n        newTaskDiv.parentNode.removeChild(newTaskDiv);\n    });\n\n    return deleteButton;\n}\n\n//# sourceURL=webpack:///./src/app.js?");
